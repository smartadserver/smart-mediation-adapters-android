...
For instance you can import _InMobi_ and _Tapjoy_ as follows:
    ...
    implementation('com.smartadserver.android.mediation:smart-display-sdk-with-inmobi:7.17.0.0')
    implementation('com.smartadserver.android.mediation:smart-display-sdk-with-vungle:7.17.0.0')

> **Note on version numbers:**
>
> The latest version is: **7.17.0.0**
>
...
> For instance, 7.17.0.0 will import the first technical release of the adapters with the _Smart Display SDK_ 7.17.0.
