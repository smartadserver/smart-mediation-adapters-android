...
For instance you can import _InMobi_ and _Tapjoy_ as follows:
    ...
    implementation('com.smartadserver.android.mediation:smart-display-sdk-with-inmobi:7.8.1.0')
    implementation('com.smartadserver.android.mediation:smart-display-sdk-with-vungle:7.8.1.0')

> **Note on version numbers:**
>
> The latest version is: **7.8.1.0**
>
